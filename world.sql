...
# C:\xampp\mysql\bin\mysql -uroot --default_character_set=utf8  <C:\Users\Bikan\Documents\bazeZaVjezbanje\world.sql
...
values (1,'Djakovo','HRV','Hrvatska',14321);

update city set Population= 13242 where id=1;
select * from city where District like '%ce%';
select * from city where Population <=300000;
select * from country where name like '%cro%' ;